 ...
 */
$conf['settings']['ics']['subscription.key'] = 'a73e507c0eb4341bc5b6';              // must be set to allow webcal subscriptions
...
$conf['settings']['phpmailer']['smtp.host'] = 'mail.utad.pt';               // 'smtp.company.com'
